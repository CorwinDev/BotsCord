...
router.post('/add', async function (req, res) {
    if (req.user) {
        ...
        if (!checkServer) {
            return res.redirect("https://discord.com/oauth2/authorize?client_id=870001234583621713&permissions=314433&redirect_uri=https%3A%2F%2Fbotscord.xyz%2Fauth%2Fcallback&response_type=code&scope=applications.commands%20bot&guild_id=" + req.body.serverid);
        } else {
